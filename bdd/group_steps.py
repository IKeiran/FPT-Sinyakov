...
@pytest.allure.step("Given group with name={name}, header = {header} and footer={footer}")
...
def verify_group_added(db, group_list, new_group):
    with pytest.allure.step("When the new group list is equal to the old list with the added group"):
